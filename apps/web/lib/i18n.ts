...
const ZH: Dict = {
  ...
  "home.section.job.add": "+ 添加",
  "home.placeholder.job.custom": "例：高级 iOS 工程师 / SRE / 量化研究员……",
  "home.error.job.custom": "请填写自定义岗位名称",
  "home.error.job.duplicate": "已存在同名的自定义岗位",
  "home.aria.job.remove": "删除自定义岗位",
  ...
  "interview.placeholder": "输入你的回答（Cmd/Ctrl+Enter 发送）",
  "interview.send": "发送回答",
  "interview.skip": "跳过",
  "interview.skip.aria": "跳过当前问题并查看参考答案",
  "interview.skipped.label": "（跳过）",
  "interview.copy": "复制",
  "interview.copied": "已复制",
...
const EN: Dict = {
  ...
  "home.error.job.duplicate": "A custom role with this name already exists",
  "home.aria.job.remove": "Remove custom role",
  ...
  "home.history.new": "New interview",
